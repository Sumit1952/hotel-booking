    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
                    ...
                    <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500 ">
                        <div className="flex flex-col">
                          ...
                          <input className="w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none" type="date" id="checkInDate" placeholder="Check_In"></input>
                        </div>
                        ...
                        <div className="flex flex-col">
                          ...
                          <input className="w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none" type="date" id="checkOutDate" placeholder="Check_Out"></input>
                        </div>
                        ...
                        <div className="w-px h-15 bg-gray-300/70 max-md:hidden"></div>
                         ...
                         <div className="flex flex-col">
                          ...
                          <input className="max-w-20 rounded border-gray-300 px-3 py-2 mt-1.5 outline-none" type="number" id="guests" placeholder="0" required></input>
                        </div>
                      
                        
                    </div>
                    <button type="submit" className=" cursor-pointer bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base  ">Check Availability</button>
        </form>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500" >
         ...
         {/* Hosted by*/}
        <div className="flex flex-col items-syart gap-4">
