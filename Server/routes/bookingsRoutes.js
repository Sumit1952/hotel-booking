...
import { createBooking , checkAvailabilityAPI , getUserBookings , getHotelBookings , stripePayment , verifyStripePayment } from '../controllers/bookingsController.js';
...
bookingsRoutes.post("/verify-stripe", protect , verifyStripePayment);
